...
summary: |-
  ...
  ・Gemini 3 Proを基盤とし、高度な推論力と世界知識により文脈に富んだ正確なビジュアルを生成します。
  ・複数の言語で、画像内に正確で読みやすいテキストを直接描画できることが特長です。
  ・リアルタイム情報を活用したインフォグラフィックの作成や、多様なテクスチャ・フォントを用いたデザインが可能で、Geminiアプリなどで利用できます。
read: false
ignored: false
pinned: false
memo: ""
