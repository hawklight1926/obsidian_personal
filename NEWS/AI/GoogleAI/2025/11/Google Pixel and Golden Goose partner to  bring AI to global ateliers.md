...
summary: |-
  ...
  - 店頭ではGoogle PixelとGeminiアプリを使用し、顧客がAIでデジタルアートを共同制作できます。
  - 生成されたデザインはGolden Gooseの職人によってスニーカーに手作業で施され、オリジナル商品として提供されます。
  - この取り組みは、デジタル技術と伝統的職人技を融合させた新しい顧客体験の実現を目指しています。
read: false
ignored: false
pinned: false
memo: ""
