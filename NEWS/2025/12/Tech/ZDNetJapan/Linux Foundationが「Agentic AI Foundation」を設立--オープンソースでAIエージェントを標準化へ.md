...
summary: |-
  Linux Foundationが「Agentic AI Foundation（AAIF）」を設立し、AIエージェントの標準化を推進します。
  - オープンソースに基づき、相互運用性と透明なガバナンスを確立することを目指しています。
  - 基盤技術として、Anthropicの「Model Context Protocol」やOpenAIの「AGENTS.md」などを統合します。
  - これにより、ベンダー間の共通標準とコミュニティ主導の開発を通じたエコシステムの構築を促進します。
read: false
ignored: false
pinned: false
memo: ""
