...
summary: |-
  Linux FoundationがAIエージェントの標準化を目指す「Agentic AI Foundation（AAIF）」を設立しました。
  - オープンで相互運用可能なAIエージェントのインフラ構築と、オープンソースに基づくガバナンス確立を目指します。
  - 基盤技術として、Anthropicの「Model Context Protocol」やOpenAIの「AGENTS.md」などが寄贈されました。
  - これにより、プロプライエタリー化ではなく透明性の高い共通標準とコミュニティ主導の開発を促進します。
read: false
ignored: false
pinned: false
memo: ""
