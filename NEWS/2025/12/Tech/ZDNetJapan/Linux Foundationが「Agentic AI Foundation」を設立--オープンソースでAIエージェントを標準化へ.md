---
url: https://japan.zdnet.com/article/35241502/
...
summary: |-
  Linux Foundationが「Agentic AI Foundation」を設立し、AIエージェントのオープンな標準化を推進します。
  - コンソーシアムにはOpenAIやAnthropicなどの主要企業が参加し、相互運用性と透明性のあるガバナンスの確立を目指します。
  - 基盤技術として、Anthropicの「Model Context Protocol」やOpenAIの「AGENTS.md」などのオープンソースプロジェクトを統合します。
  - これにより、プロプライエタリー化ではなく、共通標準に基づいたAIエージェント・インフラの開発を促進します。
read: false
ignored: false
pinned: false
memo: ""
