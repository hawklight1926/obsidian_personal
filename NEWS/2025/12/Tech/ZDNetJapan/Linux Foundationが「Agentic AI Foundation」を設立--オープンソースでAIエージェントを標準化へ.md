...
summary: |-
  Linux Foundationは「Agentic AI Foundation」を設立し、AIエージェントのオープンな標準化を推進します。
  - コンソーシアムにはOpenAIやAnthropicなどの主要企業が参加し、相互運用性と透明なガバナンスを目指します。
  - 基盤技術として、Anthropicの「Model Context Protocol」やOpenAIの「AGENTS.md」などを統合します。
  - これにより、プロプライエタリー化ではなく、共通標準に基づいたAIエージェントのエコシステム構築を促進します。
read: false
ignored: false
pinned: false
memo: ""
