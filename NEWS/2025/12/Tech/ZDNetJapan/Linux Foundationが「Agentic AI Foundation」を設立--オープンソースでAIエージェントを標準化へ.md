...
summary: |-
  ...
  - コンソーシアムにはOpenAIやAnthropicなど主要企業が参加し、相互運用性と透明性のあるガバナンスの確立を目指します。
  - 基盤技術として、Anthropicの「Model Context Protocol」やOpenAIの「AGENTS.md」などの仕様を統合します。
  - これにより、プロプライエタリー化を防ぎ、コミュニティ主導でAIエージェントのインフラを発展させることを目的としています。
read: false
ignored: false
pinned: false
memo: ""
