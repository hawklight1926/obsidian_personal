---
url: https://japan.zdnet.com/article/35241172/
date: 2025-12-03T09:45:00+09:00
updated: 
category: Tech
rss: ZDNetJapan
...
summary: |-
  AWSはre:Inventカンファレンスで、DevOpsとセキュリティタスクを自動化する3種類のエージェント型AIを発表しました。  
  ・「フロンティアエージェント」は、人間の介入なしに長時間稼働し、コード記述以外の関連作業も処理します。  
  ・具体的には、コードリポジトリーの更新やアプリケーション障害の監視、コード脆弱性の分析などを自動化します。  
  ・Kiroエージェントは開発者サイトから、Security AgentとDevOps AgentはAWS管理コンソールから利用可能です。
read: false
ignored: false
pinned: false
memo: ""
