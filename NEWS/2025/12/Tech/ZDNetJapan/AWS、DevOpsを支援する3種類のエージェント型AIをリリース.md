...
summary: |-
  AWSはre:Inventカンファレンスで、DevOpsを支援する3種類のエージェント型AIを発表しました。  
  ・「フロンティアエージェント」と称されるこれらは、自律的かつ長期間の稼働が可能です。  
  ・具体的には、コードリポジトリーの更新やアプリケーション障害の監視、コード脆弱性の分析などのタスクを自動化します。  
  ・Kiroエージェントは開発者サイトから、Security AgentとDevOps AgentはAWS管理コンソールからそれぞれ利用可能です。
read: false
ignored: false
pinned: false
memo: ""
