---
url: https://japan.zdnet.com/article/35241272/
date: 2025-12-05T16:58:00+09:00
updated: 
category: Tech
rss: ZDNetJapan
...
summary: |-
  ちゅうぎんフィナンシャルグループは、営業力強化を目的にSalesforceの金融サービス向けCRM「Agentforce Financial Services」を導入しました。
  - 顧客データを一元管理し、ライフイベントに基づくパーソナライズ提案を可能にします。
  - 属人的な営業から脱却し、グループ内で共通の顧客情報を活用した連携を強化します。
  - ノーコードツールによる迅速なカスタマイズで、環境変化への対応力向上とコスト削減を図ります。
read: false
ignored: false
pinned: false
memo: ""
