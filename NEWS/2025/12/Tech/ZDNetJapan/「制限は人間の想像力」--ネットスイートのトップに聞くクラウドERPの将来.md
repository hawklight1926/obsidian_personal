...
summary: |-
  オラクルはクラウドERP「NetSuite」の次世代版「NetSuite Next」を発表し、AIによる業務革新を提示しました。
  ・自然言語で操作できる「Ask Oracle」を中心に、会話形式でのシステム利用を可能にします。
  ・非構造化データの活用や外部AIとの連携により、業務の自動化と高度な分析を実現します。
  ・創業者は、AIがビジネス運営を改善する力となり、その可能性はユーザーの想像力が鍵だと述べています。
read: false
ignored: false
pinned: false
memo: ""
