---
url: https://japan.zdnet.com/article/35241328/
...
summary: |-
  学生の学習効率と整理能力の向上に役立つ、Linux向けの厳選ソフトウェア7つが紹介されています。  
  ・文書作成やデータ分析には、オフィススイート「LibreOffice」が利用できます。  
  ・AIをローカルで安全に使用するためには、「Ollama」と「Msty」の組み合わせが推奨されています。  
  ・化学の学習には周期表ツール「Kalzium」、天文学の学習にはプラネタリウムソフト「Stellarium」が役立ちます。
read: false
ignored: false
pinned: false
memo: ""
