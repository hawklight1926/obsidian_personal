...
summary: |-
  ...
  - レポート作成には、文書やスプレッドシートなどに対応した無料のオフィススイート「LibreOffice」が有用です。
  - 調査研究のためのAIツールとしては、プライバシーを確保できるローカル環境で動作する「Ollama」と「Msty」の組み合わせが推奨されています。
  - 化学の学習には周期表アプリ「Kalzium」が、天文学の学習にはプラネタリウムソフト「Stellarium」が役立ちます。
read: false
ignored: false
pinned: false
memo: ""
