...
summary: |-
  ...
  - 選出された10種類の拡張機能のうち4つはAIブラウザーコンパニオンで、PDFのチャットや文章作成などを支援します。
  - 生産性向上ツールには、会議の自動文字起こしや学習支援など、AIを活用した拡張機能が含まれています。
  - リストはAIに偏らないようクリエイティブなツールも選出し、Chromeをオンライン活動の中心に据える意図を示しています。
read: false
ignored: false
pinned: false
memo: ""
