---
url: https://japan.zdnet.com/article/35241265/
...
summary: |-
  4MLinux 50.0は、ゼロから構築されたLinuxディストリビューションの最新版です。
  - セキュリティ強化のため、ソースコードから常に同じバイナリを生成する「再現可能なビルド」をサポートしました。
  - マルチメディア機能として、メディア処理・再生ツールを提供する「GPAC」フレームワークを追加しています。
  - これにより、ソフトウェアの正当性を検証しやすくなるとともに、動画や音声などのコンテンツ消費が充実しました。
read: false
ignored: false
pinned: false
memo: ""
