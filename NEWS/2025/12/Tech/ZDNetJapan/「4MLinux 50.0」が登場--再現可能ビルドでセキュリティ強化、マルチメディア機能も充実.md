...
summary: |-
  ...
  - セキュリティ強化のため、ソースコードから常に同一のバイナリーを生成する「再現可能なビルド」をサポートしました。
  - マルチメディア機能が充実し、GPACフレームワークにより様々な形式のメディア処理・再生が可能です。
  - プリインストールソフトウェアが更新され、OSの機能や外観を開発者が完全に制御できる特徴は継承されています。
read: false
ignored: false
pinned: false
memo: ""
