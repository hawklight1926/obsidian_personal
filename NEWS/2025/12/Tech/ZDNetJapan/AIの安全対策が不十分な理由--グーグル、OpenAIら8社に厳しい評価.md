...
summary: |-
  主要AI企業8社の安全対策は、非営利団体FLIの調査で十分な評価を得られませんでした。
  - 最高評価のAnthropic、Google DeepMind、OpenAIでも「C+」「C+」「C」と、合格点ぎりぎりでした。
  - 特に「存亡に関わる安全性」のカテゴリーでは全社が低評価で、強力なAIのリスク管理戦略が不足しています。
  - 調査は、企業がスーパーインテリジェンス開発を急ぐ一方、制御不能を防ぐ具体的な安全プロトコルを欠いている現状を明らかにしました。
read: false
ignored: false
pinned: false
memo: ""
