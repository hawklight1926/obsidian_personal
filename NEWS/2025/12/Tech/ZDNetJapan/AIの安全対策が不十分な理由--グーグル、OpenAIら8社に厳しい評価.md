...
summary: |-
  ...
  - 最高評価のAnthropic、Google DeepMind、OpenAIでも「C+」「C+」「C」と、合格点ギリギリでした。
  - 特に「存亡に関わる安全性」を含む、具体的な安全対策やガバナンスの基本において、全社が不十分と指摘されています。
  - 調査は、強力なAIの開発競争が進む中、安全性の確保が追いついていない現状を明らかにするものです。
read: false
ignored: false
pinned: false
memo: ""
