...
summary: |-
  ...
  - 最高評価のAnthropic、Google DeepMind、OpenAIでも「C+」「C+」「C」と合格点ギリギリでした。
  - 特に「存亡に関わる安全性」のカテゴリーでは全社が低評価で、極端なリスク管理への備えが不十分と指摘されています。
  - 調査は、企業が強力なAIの開発を急ぐ一方で、具体的な安全プロトコルや独立した監視を欠いている現状を明らかにしました。
read: false
ignored: false
pinned: false
memo: ""
