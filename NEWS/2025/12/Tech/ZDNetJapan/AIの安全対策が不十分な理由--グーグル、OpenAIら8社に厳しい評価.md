...
summary: |-
  非営利団体FLIの調査により、主要AI企業8社の安全対策が全体的に不十分であると評価されました。
  - 最高評価のAnthropic、Google DeepMind、OpenAIでも「C+」「C」と合格点ギリギリでした。
  - 特に「存亡に関わる安全性」を含む6つの基準で、具体的な安全策やガバナンスの欠如が指摘されています。
