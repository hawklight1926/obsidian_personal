...
summary: |-
  ...
  - 最高評価のAnthropic、Google DeepMind、OpenAIでも「C+」「C+」「C」と、かろうじて合格点に留まりました。
  - 特に「存亡に関わる安全性」のカテゴリーでは全社が低評価で、強力なAIシステムのリスク管理戦略が欠如しています。
  - 調査は、企業がスーパーインテリジェンスの開発を急ぐ一方で、制御不能を防ぐ具体的な安全プロトコルを備えていない現状に警鐘を鳴らしています。
read: false
ignored: false
pinned: false
memo: ""
