...
summary: |-
  ...
  - 最高評価のAnthropic、Google DeepMind、OpenAIでも「C+」「C+」「C」と、かろうじて合格点でした。
  - 特に「存亡に関わる安全性」のカテゴリーでは全社が低評価で、強力なAIリスクへの備えが不十分と指摘されています。
  - FLIは、企業が安全プロトコルを欠いたまま「スーパーインテリジェンス」開発を急ぐ現状に警鐘を鳴らしています。
read: false
ignored: false
pinned: false
memo: ""
