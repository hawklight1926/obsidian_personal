...
summary: |-
  Auroraは、セキュリティが強化されたイミュータブルなLinuxディストリビューションであり、初心者にも使いやすい設計です。
  - システムコアが読み取り専用で、従来のOSより高いセキュリティを実現しています。
  - Fedoraベースで、Flatpakアプリを中心に、すぐに使い始められる合理的なデフォルト設定が特徴です。
  - オフィススイートは含まれませんが、付属のパッケージマネージャー「Bazaar」から簡単にインストールできます。
read: false
ignored: false
pinned: false
memo: ""
