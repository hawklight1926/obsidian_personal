---
url: https://japan.zdnet.com/article/35240986/
...
summary: |-
  Auroraは初心者向けのイミュータブルLinuxディストリビューションであり、高いセキュリティと使いやすさを特徴としています。
  - システムのコア部分が読み取り専用で変更不可能なため、従来のOSよりセキュリティが優れています。
  - FedoraベースでFlatpakアプリを重視し、理にかなったデフォルト設定によりインストール後すぐに使用できます。
  - オフィススイートはデフォルトでは含まれませんが、付属のパッケージマネージャー「Bazaar」から簡単にインストール可能です。
read: false
ignored: false
pinned: false
memo: ""
