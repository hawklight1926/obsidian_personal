...
summary: |-
  ...
  - ユーザーはファイルをアップロードするか、プロンプトを入力するだけで、AIが内容を解析してスライドを作成します。
  - 現在はパブリックベータ版として無料で利用可能で、生成されたプレゼンはPDFなどでダウンロードや共有が可能です。
  - ただし、動作にはChromiumベースのブラウザが必要で、ファイルのアップロードから生成までに時間を要する場合があります。
read: false
ignored: false
pinned: false
memo: ""
