...
summary: |-
  ...
  - ユーザーは素材をアップロードするか、プロンプトを入力するだけで、AIがプレゼンテーションを作成します。
  - 現在はパブリックベータ版として無料で提供されており、Chromiumベースのブラウザーでの利用が推奨されています。
  - 生成されたプレゼンテーションは、PDFや画像としてダウンロードしたり、他者と共有したりすることが可能です。
read: false
ignored: false
pinned: false
memo: ""
