...
summary: |-
  Googleが提供するAIツール「Mixboard」は、写真やドキュメントからプレゼンテーションを自動生成します。
  - ユーザーはファイルをアップロードするか、プロンプトを入力することで、AIが内容を解析しスライドを作成します。
  - 現在はパブリックベータ版として無料で提供されており、ChromeなどのChromiumベースのブラウザーでの利用が推奨されています。
  - 生成されたプレゼンテーションは、PDFや画像形式でダウンロードしたり、他者と共有したりすることが可能です。
read: false
ignored: false
pinned: false
memo: ""
