---
url: https://japan.zdnet.com/article/35241504/
...
summary: |-
  Googleは、AIが写真やドキュメントからプレゼンテーションを自動生成するツール「Mixboard」をパブリックベータ版で無料提供しています。
  - ユーザーはファイルをアップロードするかプロンプトを入力すると、AI「Nano Banana Pro」が解析してスライドを作成します。
  - 現在はChromiumベースのブラウザーでのみ動作し、処理には時間を要する場合があります。
  - 生成されたプレゼンテーションは、そのまま発表したり、PDFなどでダウンロードして他ツールで編集することも可能です。
read: false
ignored: false
pinned: false
memo: ""
