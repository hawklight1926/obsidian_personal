...
summary: |-
  ...
  - ユーザーはファイルをアップロードするか、プロンプトを入力することで、AIが内容を解析してスライドを作成します。
  - 現在はパブリックベータ版として無料で提供されており、生成されたプレゼンはPDFなどでダウンロード可能です。
  - ただし、動作にはChromiumベースのブラウザが必要で、ファイルのアップロードから完成までには時間を要する場合があります。
read: false
ignored: false
pinned: false
memo: ""
