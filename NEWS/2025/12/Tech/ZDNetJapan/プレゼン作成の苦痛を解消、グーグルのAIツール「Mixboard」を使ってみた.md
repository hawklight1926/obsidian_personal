...
summary: |-
  ...
  - ユーザーは写真やドキュメントをアップロードすると、AIが解析してプレゼンテーションを自動生成します。
  - 現在はChromeなどのChromiumベースのブラウザーでのみ動作し、生成には時間を要する場合があります。
  - 完成したプレゼンテーションはダウンロードや共有が可能で、Mixboard内から直接発表することもできます。
read: false
ignored: false
pinned: false
memo: ""
