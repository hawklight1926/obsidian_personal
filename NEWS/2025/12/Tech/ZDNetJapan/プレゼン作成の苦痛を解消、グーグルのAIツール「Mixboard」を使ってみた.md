...
summary: |-
  ...
  - ユーザーは素材をアップロードするかプロンプトを入力すると、AIが解析してスライドを作成します。
  - 現在はパブリックベータ版として無料で提供され、ChromeなどのChromiumベースブラウザでの利用が推奨されています。
  - 生成されたプレゼンテーションはPDFや画像としてダウンロード可能で、他ツールでの編集や共有もできます。
read: false
ignored: false
pinned: false
memo: ""
