---
url: https://japan.zdnet.com/article/35241536/
...
summary: |-
  Linuxのファイル検索を容易にする4つのGUIツールを紹介します。  
  ・Catfishはシンプルで高速な検索ツールであり、ファジー検索に対応しています。  
  ・FSearchは圧倒的な検索速度を持ち、入力しながら検索結果を表示します。  
  ・Snoopはファイル内の文字列検索が可能であり、高度な検索機能を備えています。  
  これらはコマンドラインを使わずに、直感的な操作でファイル検索を可能にします。
read: false
ignored: false
pinned: false
memo: ""
