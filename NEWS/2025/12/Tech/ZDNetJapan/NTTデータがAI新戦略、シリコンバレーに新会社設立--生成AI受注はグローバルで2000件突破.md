...
summary: |-
  ...
  - 今後は「タスクの自動化」から「プロセス・ビジネスの自動化」へ移行し、2027年度にAIエージェント関連で売上高3000億円を目指します。
  - 実現のため、OpenAIやMistral AIなどと連携し、幅広い用途に対応した言語モデル提供体制を整えています。
  - また、SalesforceやServiceNowとの協業により、特定業務に特化したアプリケーションやツールの拡大を進めています。
read: false
ignored: false
pinned: false
memo: ""
