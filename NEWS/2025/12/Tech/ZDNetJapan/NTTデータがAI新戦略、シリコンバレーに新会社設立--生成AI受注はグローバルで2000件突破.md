...
summary: |-
  ...
  - エージェンティックAIによる「プロセスの自動化」へ重点を移し、2027年度にAIエージェント関連で売上高3000億円を目指しています。
  - 「Smart AI Agent」の推進により、マーケティングや製造現場など多様な業務での適用と、AI同士の連携を実現します。
  - OpenAIやMicrosoftなどとの戦略的提携を強化し、幅広いAIモデルとプラットフォームを提供する体制を整えています。
read: false
ignored: false
pinned: false
memo: ""
