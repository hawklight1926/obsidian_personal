...
summary: |-
  Google検索のメインページに追加されたプラス記号から、直接ファイルや画像をアップロードしてAIモードを利用できるようになりました。
  ・これまでAIモード内でのみ可能だったファイル分析が、検索バーから直接行えるようになり、利便性が向上しています。
  ・具体的には、PDFなどの文書をアップロードし、その内容についてAIに質問することが可能です。
  ・この機能は、AIモードが提供されている全地域で、デスクトップ版を中心に順次展開される予定です。
read: false
ignored: false
pinned: false
memo: ""
