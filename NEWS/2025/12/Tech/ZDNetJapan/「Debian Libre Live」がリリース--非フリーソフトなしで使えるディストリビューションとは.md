---
url: https://japan.zdnet.com/article/35241307/
...
summary: |-
  ...
  ・これは、2022年に広範なハードウェア互換性のために非フリーファームウェアを含めた方針変更に対するユーザーの批判を受けた妥協案です。
  ・完全にフリーなオープンソースソフトウェアのみを求めるユーザーの要望に応えるものですが、現時点ではamd64アーキテクチャのみで、デフォルトのGUIは搭載されていません。
  ・このリリースは、自由なソフトウェアサプライチェーンを重視するユーザー向けの、初期段階の選択肢となります。
read: false
ignored: false
pinned: false
memo: ""
