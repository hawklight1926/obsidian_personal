...
summary: |-
  ...
  - これは、2022年に非フリーファームウェアを含める方針変更に反発したユーザーの要望に応えるものです。
  - 完全にフリーなオープンソースソフトウェアのみで構成され、ソフトウェアサプライチェーンの透明性向上を目指しています。
  - 現時点ではx86アーキテクチャのみ対応で、デフォルトのGUIはなく、上級ユーザー向けの初期リリースとなっています。
read: false
ignored: false
pinned: false
memo: ""
