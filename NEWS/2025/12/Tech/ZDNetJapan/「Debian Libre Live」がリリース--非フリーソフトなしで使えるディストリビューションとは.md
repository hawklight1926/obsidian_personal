...
summary: |-
  ...
  - これは、2022年にハードウェア互換性向上のため非フリーファームウェアを含めた従来の方針に対するユーザー批判への対応策です。
  - 完全にフリーなオープンソースソフトウェアのみを求めるユーザー向けで、現時点ではamd64アーキテクチャのみ対応しています。
  - デフォルトのGUIデスクトップ環境は搭載されておらず、上級ユーザーを対象とした初期リリースという位置付けです。
read: false
ignored: false
pinned: false
memo: ""
