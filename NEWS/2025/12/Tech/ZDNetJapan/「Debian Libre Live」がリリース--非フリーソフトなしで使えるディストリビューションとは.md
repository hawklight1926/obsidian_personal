...
summary: |-
  ...
  - これは、2022年にハードウェア互換性向上のために非フリーファームウェアを含めた変更に反発したユーザーへの対応策です。
  - 完全にフリーなオープンソースソフトウェアのみを求めるユーザーの要望に応えることを目的としています。
  - 現時点ではamd64アーキテクチャのみに対応し、デフォルトのGUIデスクトップは搭載されていません。
read: false
ignored: false
pinned: false
memo: ""
