...
summary: |-
  ...
  * これは、2022年に非フリーファームウェアを含める方針変更に反発した純粋主義者のユーザー要望への対応です。
  * 安定したDebianを基盤としていますが、現時点ではamd64アーキテクチャのみ対応で、デフォルトのGUIデスクトップは搭載されていません。
  * 完全にフリーなソフトウェアのみを求めるユーザー向けの選択肢として提供されています。
read: false
ignored: false
pinned: false
memo: ""
