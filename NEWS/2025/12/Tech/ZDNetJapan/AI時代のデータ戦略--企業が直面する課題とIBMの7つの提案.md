...
summary: |-
  生成AIの活用拡大に伴い、企業はデータ関連人材の確保とデータ準備に課題を抱えています。
  - IBMの調査では、82%のCDOが新たなデータ関連人材を採用しており、必要性が高まっています。
  - 一方で、自社のデータ能力でAI収益源を支えられると確信するCDOは26%のみで、データ準備が主要な課題です。
  - データ戦略へのIT予算割合は13%に増加し、多くの企業が戦略の統合を進めています。
read: false
ignored: false
pinned: false
memo: ""
