...
summary: |-
  NECはAIセキュリティ強化を目的とした新たな3種類のガバナンスサービスを開始しました。
  - 新サービスは「AIシステムリスクアセスメント」「AIガバナンスプラットフォーム導入」「AIリスクモニタリング」で、生成AIのリスク低減を支援します。
  - これらはNECのコンサルティングとCisco Systemsの「Cisco AI Defense」を組み合わせて開発されました。
