...
summary: |-
  ...
  ・既存のコンサルティングサービスに、Cisco Systemsの「Cisco AI Defense」を組み合わせたサービスです。
  ・具体的には「AIシステムリスクアセスメント」「AIガバナンスプラットフォーム導入」「AIリスクモニタリング」を提供します。
  ・これにより、AIシステムの実装・運用におけるリスクの発見・検出・保護を支援します。
  販売価格は税別500万円からで、金融・製造業や公共機関などを主な対象としています。
read: false
ignored: false
pinned: false
memo: ""
