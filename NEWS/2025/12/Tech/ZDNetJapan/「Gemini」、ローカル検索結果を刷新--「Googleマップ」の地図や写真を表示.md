...
summary: |-
  Geminiは、ローカル検索結果にGoogleマップの地図や写真などを表示する視覚的な形式を追加しました。  
  ・検索結果には、地図上の位置、店舗写真、評価、レビュー要約などの情報が統合されます。  
  ・これにより、店舗の場所や外観を一目で把握でき、利便性が向上しています。  
  ・この新機能は、デスクトップ版およびモバイル版のGeminiアプリで利用可能です。
read: false
ignored: false
pinned: false
memo: ""
