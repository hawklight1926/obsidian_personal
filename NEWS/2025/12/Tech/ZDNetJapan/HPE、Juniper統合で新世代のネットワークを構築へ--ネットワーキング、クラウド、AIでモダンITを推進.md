...
summary: |-
  HPEはJuniper Networks買収完了を受け、ネットワーキング、クラウド、AIを基盤とする「モダンIT」の構築を推進しています。
  ・買収により統合された「HPE Networking」は、AI時代に必須の高性能・低遅延ネットワークを提供します。
  ・具体的には、自己最適化・自己修復機能を持つ「セルフドライビングネットワーク」や、Wi-Fi 7アクセスポイントなどの新製品・技術を展開します。
  ・さらに、NVIDIAとの「AI Factory」構想にもJuniperの技術を統合し、AIクラスター間の長距離接続などを強化します。
read: false
ignored: false
pinned: false
memo: ""
