...
summary: |-
  HPEはJuniper Networks買収完了を受け、ネットワーキング、クラウド、AIを3本柱とした「モダンIT」の構築を推進しています。
  - 買収したJuniperと既存のArubaを「HPE Networking」ブランドに統合し、AI時代に必要な高性能ネットワークを提供します。
  - 具体的には、Wi-Fi 7アクセスポイントのデュアル管理対応や、両社のAI機能を相互統合する計画を発表しました。
  - さらに、NVIDIAとの「AI Factory」構想にもJuniperのルーティングプラットフォームを組み込み、大規模AIクラスター接続を強化します。
read: false
ignored: false
pinned: false
memo: ""
