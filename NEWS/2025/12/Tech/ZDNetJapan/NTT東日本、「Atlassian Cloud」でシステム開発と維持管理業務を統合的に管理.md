...
summary: |-
  ...
  ・プロジェクト管理のJiraや情報共有のConfluenceなどにより、業務状況の可視化と効率化を推進しています。
  ・ITサービスマネジメントにはJira Service Managementを活用し、問い合わせ対応などの情報を一元管理しています。
  ・Atlassian GuardとMicrosoft Entra IDの連携により、セキュリティ強化と利便性向上も図られています。
read: false
ignored: false
pinned: false
memo: ""
