...
summary: |-
  ...
  - 数千台のサーバーで構成されるプライベートクラウド基盤「Savanna」の運用・拡張において、業務フローのモダナイズが課題でした。
  - JiraやConfluenceによりプロジェクト状況を可視化し、Jira Service Managementで問い合わせ対応を一元管理しています。
  - Atlassian GuardとMicrosoft Entra IDの連携でセキュリティを強化し、社内リクエスト情報の効率的な管理を可能にしました。
read: false
ignored: false
pinned: false
memo: ""
