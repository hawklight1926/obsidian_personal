...
summary: |-
  リコーはオンプレミス環境向けに最適化した日本語大規模言語モデル「リコー LLM（27B）」を発表しました。  
  ・Google「Gemma 3 27B」をベースに、低コストかつ省電力での運用が可能です。  
  ・図表や技術図面などを読み解くマルチモーダルモデルの開発も強化し、非構造化データの資産化を進めています。  
  ・企業の暗黙知を活用するため、複数のRAGを連携させる「秘伝のタレプラットフォーム」をAIトランスフォーメーションとして提供します。
read: false
ignored: false
pinned: false
memo: ""
