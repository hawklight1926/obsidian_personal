...
summary: |-
  リコーはオンプレミス環境向けに、省電力・低コストで導入可能な日本語大規模言語モデル「リコー LLM（27B）」を開発しました。
  ・Googleの「Gemma 3 27B」をベースに、PCサーバーなどでの構築を可能としています。
  ・同時に、図表や技術図面などを読み解くマルチモーダルモデルの開発も強化し、非構造化データの資産化を進めています。
