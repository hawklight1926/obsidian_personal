...
summary: |-
  リコーは、オンプレミス環境での利用に最適な日本語大規模言語モデル「リコー LLM（27B）」を開発しました。
  ・Googleの「Gemma 3 27B」をベースとし、低コストかつ省電力でのプライベートLLM構築を可能にします。
  ・同時に、図表や技術図面などを含む文書情報を読み解くマルチモーダルモデルの開発も強化しています。
  ・これらを基盤とし、企業の暗黙知（非構造化データ）をAI化する「秘伝のタレAI化」という取り組みを推進しています。
read: false
ignored: false
pinned: false
memo: ""
