...
summary: |-
  リコーは、オンプレミス環境での利用に最適化された日本語大規模言語モデル「リコー LLM（27B）」を開発しました。
  ・Google「Gemma 3 27B」をベースとし、低コストかつ省電力でのプライベートLLM構築を可能にします。
  ・図表や技術図面などを読み解くマルチモーダルモデルの開発も強化し、非構造化データの資産化を進めています。
  ・これらを核とした「秘伝のタレAI化」により、企業の暗黙知を活用するAIトランスフォーメーションを提供します。
read: false
ignored: false
pinned: false
memo: ""
