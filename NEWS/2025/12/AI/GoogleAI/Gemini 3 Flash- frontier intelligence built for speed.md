...
summary: |-
  ...
  ・Gemini 3 Proと同等の高度な推論能力を維持しつつ、従来モデルより3倍高速で低コストです。  
  ・複雑なコーディングやマルチモーダル分析など、開発者向けのエージェントワークフローに優れています。  
  ・一般ユーザーはGeminiアプリや検索から、開発者はGoogle AI StudioなどのAPIを通じて利用できます。
read: false
ignored: false
pinned: false
memo: ""
