...
summary: |-
  2025年11月、GoogleはAIモデル「Gemini 3」のリリースなど、複数の主要なAIアップデートを発表しました。  
  ・Gemini 3は、検索や専用アプリで利用可能な多機能モデルで、学習や問題解決の能力が向上しています。  
  ・画像生成モデル「Nano Banana Pro」や、自律的な開発プラットフォーム「Google Antigravity」も新たに登場しました。  
  ・さらに、Google MapsやAndroid AutoにもGeminiが統合され、音声による対話型ナビゲーションなどの新機能が追加されています。
read: false
ignored: false
pinned: false
memo: ""
