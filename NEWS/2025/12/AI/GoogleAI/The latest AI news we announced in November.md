...
summary: |-
  2025年11月、Googleは新AIモデル「Gemini 3」のリリースなど、主要なAIアップデートを発表しました。  
  ・Gemini 3はマルチモーダル理解とエージェント機能を強化し、検索やアプリで利用可能です。  
  ・画像生成モデル「Nano Banana Pro」や、自律型ワークフロー開発プラットフォーム「Google Antigravity」も新登場しました。  
