...
summary: |-
  Googleは2025年11月、新AIモデル「Gemini 3」のリリースを中心とした主要なAIアップデートを発表しました。  
  ・Gemini 3はマルチモーダル理解とエージェント機能に優れ、検索や専用アプリで利用可能です。  
  ・画像生成モデル「Nano Banana Pro」やエージェント開発プラットフォーム「Google Antigravity」も新登場しました。  
  ・さらに、Google MapsやAndroid AutoへのGemini統合により、音声を活用した直感的な操作が可能になります。
read: false
ignored: false
pinned: false
memo: ""
