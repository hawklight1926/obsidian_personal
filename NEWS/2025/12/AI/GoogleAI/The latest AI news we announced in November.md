...
summary: |-
  2025年11月、Googleは新AIモデル「Gemini 3」のリリースなど主要なAIアップデートを発表しました。  
  ・Gemini 3は、検索や専用アプリで利用可能な多機能モデルで、学習や問題解決を強化します。  
  ・画像生成モデル「Nano Banana Pro」や、自律的な開発プラットフォーム「Google Antigravity」も新登場しました。  
  ・さらに、AI・クラウドインフラへテキサス州で400億ドルを投資する計画も明らかにしています。
read: false
ignored: false
pinned: false
memo: ""
