...
summary: |-
  Googleは2025年11月、AIモデル「Gemini 3」のリリースなど主要なアップデートを発表しました。  
  ・Gemini 3は高度な推論機能を持ち、検索やアプリで利用可能です。  
  ・画像生成モデル「Nano Banana Pro」や開発者向けプラットフォーム「Google Antigravity」も新登場しました。  
  ・さらに、Google MapsやAndroid AutoへのGemini統合により、音声対話型のナビゲーション機能が拡張されています。
read: false
ignored: false
pinned: false
memo: ""
