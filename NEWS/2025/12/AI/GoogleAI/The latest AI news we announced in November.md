...
summary: |-
  ...
  ・「Gemini 3」はマルチモーダル理解に優れ、検索や専用アプリで利用可能となりました。
  ・画像生成モデル「Nano Banana Pro」の公開や、開発者向けエージェントプラットフォーム「Google Antigravity」の提供を開始しました。
  ・さらに、Google MapsへのGemini統合により音声操作やランドマーク案内が強化され、AIインフラに400億ドルを投資する計画も明らかにしています。
read: false
ignored: false
pinned: false
memo: ""
