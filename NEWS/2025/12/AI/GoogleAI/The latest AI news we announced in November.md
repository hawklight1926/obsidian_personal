...
summary: |-
  ...
  - 多様な理解と推論に優れたGemini 3を、検索や専用アプリで提供開始しました。
  - 画像生成モデル「Nano Banana Pro」や、自律的な開発プラットフォーム「Google Antigravity」も新たに公開しています。
  - さらに、Google MapsやAndroid AutoへのGemini統合により、音声を活用したナビゲーションや車内操作の高度化を進めています。
read: false
ignored: false
pinned: false
memo: ""
