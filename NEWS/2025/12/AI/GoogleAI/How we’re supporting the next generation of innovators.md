...
summary: |-
  Googleはコンピュータサイエンス教育週間に合わせ、AIリテラシー促進の新たなゲーム教材「AI Quests」を公開し、教育支援に500万ドル以上を拠出しました。
  - 新教材では、実際の研究に基づきAIで眼疾患を検出する体験が可能です。
  - 2026年にはパートナーと連携し、より多くの教室へ教材を拡大します。
  - 資金は教育者の育成やK-12向けカリキュラム基準の改訂などに充てられます。
read: false
ignored: false
pinned: false
memo: ""
