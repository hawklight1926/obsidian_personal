...
summary: |-
  Googleはコンピュータサイエンス教育週間に合わせ、AIリテラシー促進のための新たな「AIクエスト」の提供と、コンピュータサイエンス教育への500万ドル超の資金支援を発表しました。  
  - ゲーム形式の学習教材「AIクエスト」では、生徒がAIモデルを用いて眼疾患の検出に挑戦する新クエストを無料公開しています。  
  - パートナー団体と連携し、2026年までに「AIクエスト」をさらに多くの教室へ拡大する計画です。  
  - Google.orgによる500万ドル超の新資金は、教育者の育成やK-12コンピュータサイエンス基準の改訂などに充てられます。
read: false
ignored: false
pinned: false
memo: ""
