...
summary: |-
  Googleはコンピュータサイエンス教育週間に合わせ、AIリテラシー向上のための新たなゲーム教材「AI Quests」を提供し、教育支援に500万ドル以上を拠出します。  
  ・「AI Quests」では、生徒がAIモデルを用いて眼疾患を検出する実践的な学習が可能です。  
  ・パートナーと連携し、2026年までにさらに多くの教室へプログラムを拡大する計画です。  
