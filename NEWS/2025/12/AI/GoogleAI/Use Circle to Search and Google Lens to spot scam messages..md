...
summary: |-
  ...
  *   不審なメッセージを画面で囲む（Circle to Search）か、スクリーンショットを分析（Lens）することで、詐欺の可能性をAIが評価します。
  *   システムはウェブ上の情報とAIを活用し、メッセージが金銭要求などの詐欺である兆候がないかを判断します。
  *   この機能は世界的に提供され、高信頼度の判断が可能な場合に、次の行動を提案するガイダンスを表示します。
read: false
ignored: false
pinned: false
memo: ""
