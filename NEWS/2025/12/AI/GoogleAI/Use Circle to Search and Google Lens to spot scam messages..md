...
summary: |-
  詐欺師がSNSやメッセージアプリで送る不審なメッセージやリンクを検出するため、Googleが「Circle to Search」と「Lens」に新機能を追加しました。
  - ユーザーは疑わしいメッセージを画面で囲むか画像で検索すると、AIが詐欺の可能性を評価します。
  - システムはウェブ情報を基に分析し、詐欺の特徴や対処法を含むガイダンスを表示します。
  - この機能は全世界で利用可能で、信頼性の高い判断が可能な場合に作動します。
read: false
ignored: false
pinned: false
memo: ""
