...
summary: |-
  GoogleがCircle to SearchとLensに、詐欺メッセージを検出する新機能を追加しました。
  - 不審なメールやSMSの内容を、Circle to SearchやLensで検索できます。
  - AIとウェブ情報を活用し、詐欺の可能性を評価し、ガイダンスを表示します。
  - この機能は世界中で利用可能で、高信頼度の判断時に作動します。
read: false
ignored: false
pinned: false
memo: ""
