...
summary: |-
  詐欺師がSNSやメッセージアプリで送る不審なリンクを検出するため、GoogleがCircle to SearchとLensに新機能を追加しました。  
  ・AIとウェブ情報を活用し、詐欺メッセージの可能性を評価します。  
  ・ユーザーは警告と具体的な対処法を示すガイダンスを受け取れます。  
  ・この機能は世界中で利用可能で、信頼性が高いと判断された場合に作動します。
read: false
ignored: false
pinned: false
memo: ""
