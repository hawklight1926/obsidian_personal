...
summary: |-
  GoogleがサークルサーチとLensに、詐欺メールを検出する新機能を追加しました。
  - 不審なメールを長押ししてサークルサーチを起動するか、Lensでスクリーンショットを分析できます。
  - AIとウェブ情報を活用し、詐欺の可能性を評価し、対策案を提示します。
  - この機能は世界中で利用可能で、信頼性の高い判断時のみ結果が表示されます。
read: false
ignored: false
pinned: false
memo: ""
