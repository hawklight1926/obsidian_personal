...
summary: |-
  詐欺師がSNSやメッセージアプリで送る不審なメッセージを検出するため、Googleは「Circle to Search」と「Lens」に新機能を追加しました。
  - ユーザーが不審なメッセージを選択し、これらの機能で検索すると、AIが詐欺の可能性を評価します。
  - 評価後は、詐欺の特徴や次の対処法に関するガイダンスが表示されます。
