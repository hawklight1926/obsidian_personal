...
summary: |-
  詐欺師がメッセージアプリやSNSを介して送る詐欺的なテキストメッセージを検出するため、Circle to SearchとLensに新機能が追加されました。  
  ・AIとウェブ情報を活用し、メッセージが詐欺の可能性を評価します。  
  ・ユーザーは評価結果と次のステップの提案を含むガイダンスを確認できます。  
  ・この機能はCircle to SearchとLensで全球的に利用可能です。
read: false
ignored: false
pinned: false
memo: ""
