...
summary: |-
  2025年のGoogleは、AIを活用したChrome拡張機能や各種サービスの年間振り返り機能を提供しました。  
  - ChromeではAIでブラウザを強化する拡張機能が紹介されました。  
  - 「Year in Search 2025」では検索トレンドをまとめた動画や分析を公開しました。  
  - Google PhotosやYouTubeでも、ユーザー個人の利用履歴に基づく年間振り返り機能が提供されています。
read: false
ignored: false
pinned: false
memo: ""
