...
summary: |-
  Googleは2025年の主要なサービス利用動向を振り返るコンテンツを公開しました。  
  ・Chrome拡張機能ではAIを活用した機能が注目され、ブラウザの効率化が進みました。  
  ・「Year in Search 2025」では検索トレンドを通じて社会の関心事を分析しています。  
  ・Google PhotosやYouTubeでは個人利用を振り返る「Recap」機能が提供されました。
read: false
ignored: false
pinned: false
memo: ""
