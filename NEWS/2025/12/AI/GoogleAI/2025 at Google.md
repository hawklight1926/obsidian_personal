...
summary: |-
  ...
  - Chrome拡張機能ではAIを活用したツールが紹介され、検索トレンドをまとめた「Year in Search 2025」も公開されています。
  - また、Google TVでは人気エンターテインメントが、Google PhotosやYouTubeではユーザー個人の利用履歴を振り返る「Recap」機能が提供されました。
read: false
ignored: false
pinned: false
memo: ""
