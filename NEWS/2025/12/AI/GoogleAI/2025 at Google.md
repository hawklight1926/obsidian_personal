...
summary: |-
  ...
  - ChromeではAI機能を強化する拡張機能が注目されました。
  - 検索トレンドをまとめた「Year in Search 2025」や、Google TVのトップエンターテインメントが公開されています。
  - また、Google PhotosやYouTubeでは、ユーザー個人の利用履歴を振り返る「Recap」機能が提供されました。
read: false
ignored: false
pinned: false
memo: ""
