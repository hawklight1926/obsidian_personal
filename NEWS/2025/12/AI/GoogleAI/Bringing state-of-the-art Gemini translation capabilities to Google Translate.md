...
summary: |-
  Google翻訳にGeminiの最先端翻訳機能を導入し、より自然で正確な翻訳を実現します。
  ・Geminiにより、慣用句や俗語などのニュアンスを含むテキスト翻訳の品質が向上します。
  ・リアルタイム音声翻訳のベータ版を導入し、ヘッドフォンで話者のトーンや強調を保った通訳が可能になります。
  ・翻訳アプリ内の言語学習ツールを拡充し、発話練習へのフィードバックや学習進捗の追跡機能を強化しました。
read: false
ignored: false
pinned: false
memo: ""
