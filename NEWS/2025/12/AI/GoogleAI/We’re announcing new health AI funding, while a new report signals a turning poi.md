...
summary: |-
  ...
  - 具体的には、救急の待ち時間を1時間以上短縮するなど、医療従事者の時間を創出しています。
  - Googleは500万ドルの資金を提供し、医療従事者自らがAIソリューションを構築・実験できるオープンソースプラットフォームを立ち上げます。
  - この取り組みにより生まれた現場主導の革新をEU全体に拡大し、患者ケアに充てる時間を増やすことを目指しています。
read: false
ignored: false
pinned: false
memo: ""
