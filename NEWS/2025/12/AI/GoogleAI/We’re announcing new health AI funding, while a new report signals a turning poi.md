...
summary: |-
  AIは科学の生産性低下の傾向を逆転させ、医療費上昇と人材不足に悩む欧州医療の転換点となっています。
  - 既に実用化されたAIは、救急の待ち時間を1時間以上短縮するなど、医療従事者の時間を創出しています。
  - Googleは500万ドルの資金を提供し、EU医療従事者が自らAIソリューションを構築・実験できるオープンソースプラットフォーム事業を開始しました。
  - この取り組みにより生まれた現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる時間の増加を目指します。
read: false
ignored: false
pinned: false
memo: ""
