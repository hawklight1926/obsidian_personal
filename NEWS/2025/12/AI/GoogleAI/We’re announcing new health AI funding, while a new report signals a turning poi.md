...
summary: |-
  AIは科学の生産性低下の長期傾向を逆転させ、医療費上昇と人材不足に悩むEU医療システムの転換点を提供しています。
  ・実務家に時間を戻しており、例えば救急待ち時間を1時間以上短縮しています。
  ・Googleは500万ドルの資金を提供し、医療従事者が自らAIソリューションを構築・実験できるオープンソースプラットフォームを立ち上げます。
  ・これにより生まれた現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる貴重な臨床時間を確保することを目指しています。
read: false
ignored: false
pinned: false
memo: ""
