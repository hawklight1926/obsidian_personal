...
summary: |-
  ...
  ・実務家の業務負荷軽減に寄与し、救急待ち時間を1時間以上短縮する例があります。
  ・Googleは500万ドルの資金提供により、医療従事者が自らAIソリューションを構築できるオープンソースプラットフォームを支援します。
  ・この取り組みはEU全体で実践者主導のイノベーションを拡大し、患者ケアに充てる時間を増やすことを目指しています。
read: false
ignored: false
pinned: false
memo: ""
