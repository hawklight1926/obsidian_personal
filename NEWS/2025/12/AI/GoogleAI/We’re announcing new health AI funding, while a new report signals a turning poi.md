...
summary: |-
  AIは科学の生産性低下の傾向を逆転させ、医療費上昇と人手不足に悩む欧州医療の転換点となっています。
  ・実務者の時間を節約し、救急の待ち時間を1時間以上短縮するなどの効果が報告されています。
  ・Googleは500万ドルの資金を提供し、医療従事者が自らAIソリューションを構築できるオープンソースプラットフォーム「Impulse Healthcare」を立ち上げます。
  ・現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる貴重な臨床時間を確保することを目指しています。
read: false
ignored: false
pinned: false
memo: ""
