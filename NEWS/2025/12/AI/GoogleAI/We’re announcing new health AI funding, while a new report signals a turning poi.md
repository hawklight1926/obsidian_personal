...
summary: |-
  AIは医療費上昇や人手不足に直面するEU医療システムの転換点となり、科学の生産性低下傾向を逆転させています。
  ・実務者の時間を創出し、救急待ち時間を1時間以上短縮するなどの実例があります。
  ・Googleは500万ドルの資金提供により、医療従事者自身がAIソリューションを構築・実験できるオープンソースプラットフォームを立ち上げます。
