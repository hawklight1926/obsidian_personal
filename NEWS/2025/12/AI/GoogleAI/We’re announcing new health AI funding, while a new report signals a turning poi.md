...
summary: |-
  AIが科学の生産性低下傾向を逆転させ、医療費上昇や人手不足に悩む欧州医療システムの転換点となっています。
  ・実例として、AI活用により救急待ち時間が1時間以上短縮されるなど、医療従事者の時間を創出しています。
  ・Googleは500万ドルの資金提供を発表し、医療従事者自らがAIソリューションを構築・実験できるオープンソースプラットフォームを推進します。
  ・この取り組みにより、現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる貴重な時間を増やすことを目指しています。
read: false
ignored: false
pinned: false
memo: ""
