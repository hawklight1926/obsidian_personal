...
summary: |-
  AIは医療費上昇や人手不足に直面する欧州医療システムの転換点となり、科学の生産性低下傾向を逆転させています。
  ・実務者の時間を創出し、救急待ち時間を1時間以上短縮するなどの効果が報告されています。
  ・Googleは500万ドルの資金提供により、医療従事者が自らAIソリューションを構築できるオープンソースプラットフォーム事業を開始しました。
  ・この取り組みは現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる時間を増やすことを目指しています。
read: false
ignored: false
pinned: false
memo: ""
