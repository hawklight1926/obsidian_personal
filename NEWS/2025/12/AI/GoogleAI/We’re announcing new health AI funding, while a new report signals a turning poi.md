...
summary: |-
  AIは科学の生産性低下の傾向を逆転させ、医療費上昇や人手不足に悩むEU医療システムの転換点となっています。
  ・実務家の時間を節約し、例えば救急の待ち時間を1時間以上短縮するなどの効果が報告されています。
  ・Googleは500万ドルの資金を提供し、医療従事者が自らAIソリューションを構築・実験できるオープンソースプラットフォーム事業を開始します。
  ・この取り組みにより生まれた現場主導の革新をEU全体に拡大し、患者ケアに充てる貴重な臨床時間を確保することを目指しています。
read: false
ignored: false
pinned: false
memo: ""
