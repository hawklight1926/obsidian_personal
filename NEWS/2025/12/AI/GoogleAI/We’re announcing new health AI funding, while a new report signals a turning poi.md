...
summary: |-
  AIは科学生産性の低下傾向を逆転させ、医療費上昇や人材不足に悩む欧州医療システムの転換点となっています。
  ・実務家の時間を創出し、救急待ち時間を1時間以上短縮するなどの効果が報告されています。
  ・Googleは500万ドルの資金を提供し、医療従事者自身がAIソリューションを構築・実験できるオープンソースプラットフォーム事業を開始しました。
  ・この取り組みにより、現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる貴重な臨床時間を確保することを目指しています。
read: false
ignored: false
pinned: false
memo: ""
