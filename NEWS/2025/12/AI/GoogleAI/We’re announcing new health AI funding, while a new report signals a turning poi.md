...
summary: |-
  AIが科学の生産性低下の傾向を逆転させ、医療費上昇や人手不足に悩む欧州医療の転換点となっています。
  ・実務者の時間を創出し、救急の待ち時間を1時間以上短縮するなどの成果が報告されています。
  ・Googleは500万ドルの資金を提供し、医療従事者自らがAIソリューションを構築・実験できるオープンソースプラットフォーム事業を開始します。
  ・この取り組みにより生まれた現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる時間を増やすことを目指しています。
read: false
ignored: false
pinned: false
memo: ""
