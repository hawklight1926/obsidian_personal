...
summary: |-
  AIは科学の生産性低下の長期傾向を逆転させ、医療費上昇と人材不足に直面する欧州医療システムの転換点を提供しています。
  ・実務家の時間を節約し、救急待ち時間を1時間以上短縮するなどの効果が報告されています。
  ・Googleは500万ドルの資金を提供し、医療従事者が自らAIソリューションを構築・実験できるオープンソースプラットフォームを立ち上げます。
  ・この取り組みにより生まれた現場主導のイノベーションをEU全体に展開し、患者ケアに充てる貴重な臨床時間を確保することが目指されています。
read: false
ignored: false
pinned: false
memo: ""
