...
summary: |-
  AIは科学生産性の低下傾向を逆転させ、医療費上昇や人手不足に悩むEU医療システムの転換点となっています。
  ・実務者の時間を創出し、救急待ち時間を1時間以上短縮するなどの成果が報告されています。
  ・Googleは500万ドルの資金を提供し、医療従事者自らがAIソリューションを構築・実験できるオープンソースプラットフォーム「Impulse Healthcare」を立ち上げます。
  ・この取り組みにより生まれた現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる貴重な臨床時間の確保を目指します。
read: false
ignored: false
pinned: false
memo: ""
