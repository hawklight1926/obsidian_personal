...
summary: |-
  AIは科学の生産性低下傾向を逆転させ、医療費上昇と人手不足に悩むEU医療システムの転換点を提供しています。
  ・実務者の時間を創出し、救急待ち時間を1時間以上短縮するなどの効果が報告されています。
  ・Googleは500万ドルの資金を提供し、医療従事者自身がAIソリューションを構築・実験できるオープンソースプラットフォーム事業を開始します。
  ・この取り組みにより生まれた現場主導のイノベーションをEU全体に拡大し、患者ケアに充てる貴重な臨床時間を増やすことを目指しています。
read: false
ignored: false
pinned: false
memo: ""
