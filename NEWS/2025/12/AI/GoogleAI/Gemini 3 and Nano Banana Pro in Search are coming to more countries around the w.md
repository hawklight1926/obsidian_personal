...
summary: |-
  ...
  - 有料サブスクリプション「Google AI Pro/Ultra」ユーザーは、複雑な質問のニュアンスを理解する高度な推論機能を利用できます。
  - マルチモーダル理解とエージェント的コーディング能力により、動的な視覚的レイアウトやインタラクティブなツールが生成されます。
  - 画像生成モデル「Nano Banana Pro」も拡大導入され、インフォグラフィックなどの視覚化を支援します。
read: false
ignored: false
pinned: false
memo: ""
