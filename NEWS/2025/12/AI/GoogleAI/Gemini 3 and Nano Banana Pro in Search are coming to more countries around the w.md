...
summary: |-
  Googleが最も高度なAIモデル「Gemini 3」を、約120の国と地域のGoogle検索AIモードに英語で提供開始しました。
  - Google AI ProおよびUltra加入者は、複雑な質問のニュアンスを理解するGemini 3 ProをAIモードで利用できます。
  - このモデルはマルチモーダル理解と強力なコーディング機能により、動的な視覚的レイアウトやインタラクティブなツールをその場で生成します。
  - 同時に、生成AI画像モデル「Nano Banana Pro」も拡大導入され、インフォグラフィックなどの視覚化を支援します。
read: false
ignored: false
pinned: false
memo: ""
