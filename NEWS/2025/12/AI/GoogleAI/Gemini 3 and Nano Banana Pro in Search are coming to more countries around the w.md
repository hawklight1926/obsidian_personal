...
summary: |-
  Googleが最も高性能なAIモデル「Gemini 3」を、約120の国と地域でGoogle検索のAIモードに導入します。
  - AI ProとUltra加入者は、Gemini 3 Proの高度な推論能力により、複雑な質問のニュアンスを理解した回答を得られます。
  - 同モデルのマルチモーダル理解と強力なコーディング機能で、動的な視覚的レイアウトやインタラクティブなツールが生成可能です。
