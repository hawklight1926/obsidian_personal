...
summary: |-
  ...
  - 有料プラン加入者は、複雑な質問のニュアンスを理解するGemini 3 Proを利用できます。
  - このモデルは動的な視覚的レイアウトやインタラクティブなツールをその場で生成する機能を備えています。
  - さらに、画像生成モデル「Nano Banana Pro」も拡大導入され、インフォグラフィックなどの可視化が可能となります。
read: false
ignored: false
pinned: false
memo: ""
