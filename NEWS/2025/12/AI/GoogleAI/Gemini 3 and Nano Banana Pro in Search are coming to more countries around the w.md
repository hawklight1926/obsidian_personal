...
summary: |-
  ...
  - 有料サブスクリプション「Google AI Pro/Ultra」ユーザーは、複雑な質問のニュアンスを理解するGemini 3 Proを利用できます。
  - このモデルは高度なマルチモーダル理解とコード生成能力により、動的な視覚的レイアウトやインタラクティブなツールをその場で生成します。
  - 同時に、画像生成モデル「Nano Banana Pro」も拡大導入され、インフォグラフィックなどの視覚化を支援します。
read: false
ignored: false
pinned: false
memo: ""
