...
summary: |-
  Googleが最も高性能なAIモデル「Gemini 3」を、約120の国と地域でGoogle検索のAIモードに提供開始しました。
  - Google AI ProおよびUltra加入者は、Gemini 3 Proの高度な推論能力を利用して、複雑な質問のニュアンスを理解できます。
  - 同モデルのマルチモーダル理解と強力なコーディング機能により、動的な視覚的レイアウトやインタラクティブなツールが生成されます。
  - 画像生成モデル「Nano Banana Pro」も拡大提供され、インフォグラフィックなどの可視化が可能です。
read: false
ignored: false
pinned: false
memo: ""
