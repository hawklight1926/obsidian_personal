...
summary: |-
  Googleが最も高性能なAIモデル「Gemini 3」を、約120の国と地域のGoogle検索AIモードに英語で提供開始しました。
  - Google AI ProおよびUltra加入者は、Gemini 3 Proの高度な推論能力により、複雑な質問のニュアンスを理解した回答を得られます。
  - 同モデルのマルチモーダル理解とエージェント的コーディング能力により、動的な視覚的レイアウトやインタラクティブなツールが生成可能です。
  - 画像生成モデル「Nano Banana Pro」も拡大導入され、Gemini 3 Proを基盤にインフォグラフィックなどの視覚化を支援します。
read: false
ignored: false
pinned: false
memo: ""
