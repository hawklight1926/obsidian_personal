...
summary: |-
  ...
  ・13点の新作は、サンフランシスコ・ベイエリアの生態系に着想を得て、人間・自然・機械の関係を探求しています。
  ・展示作品は、GoogleのツールやAIを活用して制作され、オンラインで公開されています。
  ・この取り組みは、過去のDeepDreamやアーティスト支援プログラムの延長線上にあり、AIツールの創造的可能性を示しています。
read: false
ignored: false
pinned: false
memo: ""
