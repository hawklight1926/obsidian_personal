...
summary: |-
  ...
  - サンフランシスコ・ベイエリアの生態系に着想を得た13点の新作を、オンラインおよび物理空間で展示しています。
  - 作品は、人間の知覚、機械の視覚、自然世界をつなぐAIの可能性を探求するものです。
  - 展示はGoogle Arts & Cultureで閲覧可能で、アーティストはGoogleのツールとAIを用いて環境との相互作用を拡張しています。
read: false
ignored: false
pinned: false
memo: ""
