...
summary: |-
  ...
  ・展示作品はサンフランシスコ湾岸の生態系に着想を得て、人間・自然・機械の関係を探求しています。  
  ・世界各国のアーティストがGoogleのツールとAIを活用し、知覚や相互作用の新たな形を提示しました。  
  ・オンライン展示はGoogle Arts & Cultureで公開され、物理展示はカリフォルニア州マウンテンビューのオフィスで開催されています。
read: false
ignored: false
pinned: false
memo: ""
