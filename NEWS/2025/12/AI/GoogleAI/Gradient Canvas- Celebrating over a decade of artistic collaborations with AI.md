...
summary: |-
  ...
  ・サンフランシスコ湾岸の生態系に着想を得た作品群は、人間、自然、機械の相互関係を探求しています。  
  ・世界各国のアーティストがGoogleのツールとAIを活用し、知覚や相互作用の新たな可能性を提示しました。  
  ・展示はGoogle Arts & Cultureでオンライン公開され、物理展示はカリフォルニア州マウンテンビューのオフィスで開催されています。
read: false
ignored: false
pinned: false
memo: ""
