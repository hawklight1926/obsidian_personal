...
summary: |-
  Googleフォトは2025年の思い出を振り返る「2025年 Recap」機能を提供しています。  
  - 特定の人物や写真を非表示にするなど、カスタマイズ性が向上しました。  
  - CapCut連携により専用テンプレートで編集し、ソーシャルメディアやWhatsAppへの共有が容易になっています。  
  - 米国ユーザー向けには、Gemini機能により趣味やハイライトを自動抽出する新要素も追加されました。
read: false
ignored: false
pinned: false
memo: ""
