...
summary: |-
  Googleフォトの「2025年 振り返り」機能が公開され、よりカスタマイズや共有が容易になりました。
  - 特定の人物や写真を非表示にでき、専用テンプレートでCapCut内で直接編集できます。
  - 作成した振り返りはソーシャルメディアやWhatsAppのステータスへ直接共有が可能です。
  - 米国ユーザーでGemini機能を有効にしている場合は、趣味やハイライトが自動的に表示されます。
read: false
ignored: false
pinned: false
memo: ""
