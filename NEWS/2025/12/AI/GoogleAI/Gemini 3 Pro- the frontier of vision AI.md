...
summary: |-
  Gemini 3 Proは、文書、空間、画面、動画理解において最先端の性能を発揮する、Googleの最高性能マルチモーダルモデルです。
  ・文書理解では、複雑なレイアウトや手書き文字の認識から、表や図表を跨いだ高度な推論まで行えます。
  ・空間・画面理解により、物理世界やOS画面の認識が強化され、タスク自動化などの応用が可能です。
