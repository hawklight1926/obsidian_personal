...
summary: |-
  Gemini 3 Proは、文書、空間、画面、動画理解において最先端の性能を発揮するGoogleのマルチモーデルAIモデルです。
  ・文書理解では、複雑なレイアウトや手書き文字の認識から、表や図表を跨いだ多段階の推論まで高度に処理できます。
  ・空間・画面理解では、物理世界やOS画面の構成要素を認識し、タスク自動化などの応用が可能です。
  ・動画理解では、高フレームレート処理と「思考」モードにより、単なる認識を超えた因果関係の推論を行えます。
read: false
ignored: false
pinned: false
memo: ""
