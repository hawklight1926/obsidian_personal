...
summary: |-
  ...
  ・アイスランドでは、Geminiなどを用いたパイロットプログラムを実施し、個別学習の強化と教師のAIリテラシー向上を図っています。
  ・スウェーデンでは、Geminiを導入して教材作成の効率化を実現し、教師が生徒と向き合う時間の確保に役立てています。
  ・ノルウェーでは、データ保護影響評価を完了させ、Google教育ツールの安全な利用環境を整備し、行政負担の軽減にも成功しました。
read: false
ignored: false
pinned: false
memo: ""
