...
summary: |-
  ...
  - Btrfsサブボリュームを用いたブルーグリーンデプロイメントにより、安定したアトミックアップデートとロールバックが可能です。
  - アプリケーション管理はFlatpakの統合と、システム全体の変更を実行する専用コマンド「sudo shani-deploy」で行われます。
  - この専用コマンドによるシステム更新は、環境の切り替えを伴いますが、問題なく動作することが確認されています。
read: false
ignored: false
pinned: false
memo: ""
