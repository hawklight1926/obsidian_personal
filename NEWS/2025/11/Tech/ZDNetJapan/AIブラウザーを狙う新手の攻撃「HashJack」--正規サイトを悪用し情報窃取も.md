...
summary: |-
  ...
  - URLの「#」以降に隠された悪意ある指示をAIアシスタントが処理することで実行されます。
  - 正規サイトを経由するため、不審なURLを必要とせず、従来の防御策での検出が困難です。
  - 特にPerplexityの「Comet」のようなエージェント型AIブラウザーでは、ユーザーデータが自動的に攻撃者に送信されるリスクがあります。
read: false
ignored: false
pinned: false
memo: ""
