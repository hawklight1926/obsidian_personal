...
summary: |-
  ワークデイはエージェンティックAI環境において、一元管理を実現する「Agent System of Record（ASOR）」を展開しています。
  - ASORは自社・他社・顧客開発のAIエージェントを統合管理し、「野良AI」の乱立を防ぎます。
  - 人事管理の強みを活かし、従業員とAIエージェントを一元的に管理するプラットフォームを目指しています。
  - これにより、マルチベンダー環境下でもシンプルなエージェント管理を実現することが可能です。
read: false
ignored: false
pinned: false
memo: ""
