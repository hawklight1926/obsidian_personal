...
summary: |-
  ワークデイはエージェンティックAI環境におけるプラットフォーマーを目指し、「Workday Agent System of Record（ASOR）」を展開しています。
  - ASORは、自社提供・顧客開発・他社提供のAIエージェントを一元管理し、「野良AI」の乱立を防ぎます。
  - 人事管理（HCM）の強みを活かし、従業員とAIエージェントを統合的に管理する独自のアプローチを取っています。
  - これにより、マルチベンダー環境下でのAIエージェント運用をシンプルにし、企業内での効率的な管理を実現します。
read: false
ignored: false
pinned: false
memo: ""
