...
summary: |-
  ワークデイはエージェンティックAI環境に向け「Agent System of Record（ASOR）」を展開しています。
  - ASORは自社・他社・顧客開発のAIエージェントを一元管理し、「野良AI」の乱立を防ぎます。
  - 人事・財務管理の強みを活かし、従業員とAIエージェントを統合的に管理するプラットフォームを目指しています。
  - 多様なベンダーのAIエージェント連携に対応し、企業内での効率的な運用を実現します。
read: false
ignored: false
pinned: false
memo: ""
