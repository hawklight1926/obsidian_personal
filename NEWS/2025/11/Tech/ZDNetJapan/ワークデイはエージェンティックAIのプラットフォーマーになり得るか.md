...
summary: |-
  ワークデイは、エージェンティックAI環境における一元管理を実現する「Agent System of Record（ASOR）」を展開しています。
  - ASORは、自社・他社・顧客開発のAIエージェントを一元管理し、「野良AI」の乱立を防ぎます。
  - 人事管理の強みを活かし、従業員とAIエージェントを統合的に管理するプラットフォームを目指しています。
  - 多様なベンダーのAIエージェントが連携する環境において、管理をシンプルにする役割を担います。
read: false
ignored: false
pinned: false
memo: ""
