...
summary: |-
  Black Forest Labsが画像生成AIの次世代モデル「FLUX.2」を発表しました。
  ・「FLUX.2 pro」は最高品質を、「FLUX.2 flex」は速度と品質のバランスを追求しています。
  ・最大10枚の参照画像を活用でき、文字描画やプロンプトへの忠実性が向上しています。
  ・Googleの「Nano Banana Pro」と比較してコスト面で優位性があり、「FLUX Playground」で無料体験が可能です。
read: false
ignored: false
pinned: false
memo: ""
