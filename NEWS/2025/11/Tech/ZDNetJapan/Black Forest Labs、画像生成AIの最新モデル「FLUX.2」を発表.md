...
summary: |-
  ...
  - 「FLUX.2 pro」と「FLUX.2 flex」の2種類があり、前者は最高品質、後者は速度と品質のバランスを重視しています。
  - 最大10枚の参照画像を利用可能で、文字描画やプロンプトへの忠実性などが全体的に強化されました。
  - 性能は競合モデルと互角ながらコストが抑えられており、「FLUX Playground」で1日50回まで無料体験できます。
read: false
ignored: false
pinned: false
memo: ""
