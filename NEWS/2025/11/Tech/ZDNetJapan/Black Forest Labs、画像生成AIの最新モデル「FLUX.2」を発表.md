...
summary: |-
  ...
  - モデルは最高品質を目指す「FLUX.2 pro」と、速度と品質のバランスを重視する「FLUX.2 flex」の2種類があります。
  - 最大10枚の参照画像を利用可能で、文字描画やプロンプトへの忠実性などが全体的に強化されています。
  - 性能は競合モデルに匹敵しつつコストが抑えられており、「FLUX Playground」で1日50回まで無料体験できます。
read: false
ignored: false
pinned: false
memo: ""
