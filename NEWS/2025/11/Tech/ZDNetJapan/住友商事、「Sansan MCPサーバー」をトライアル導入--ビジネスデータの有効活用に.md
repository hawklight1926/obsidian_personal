...
summary: |-
  ...
  - Sansanに蓄積された名刺や商談履歴などのビジネスデータをMicrosoft 365 Copilotで活用可能にします。
  - MCP（Model Context Protocol）を利用し、AIが外部データをリアルタイムに参照できるようになります。
  - 会議準備での関係性自動抽出や、取引履歴を踏まえた提案資料作成などの業務効率化が期待されています。
read: false
ignored: false
pinned: false
memo: ""
