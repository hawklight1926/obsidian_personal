...
summary: |-
  ...
  - Sansanに蓄積された名刺や商談履歴などのビジネスデータを、Microsoft 365 Copilot上で活用できるようにします。
  - MCP（Model Context Protocol）を活用し、外部データとAIのシームレスな連携を実現します。
  - 会議準備での関係性自動抽出や、取引履歴を踏まえた提案資料・メール作成の効率化が期待されています。
read: false
ignored: false
pinned: false
memo: ""
