---
url: "https://japan.zdnet.com/article/35240825/"
...
summary: |-
  Google Chromeの実験版「Canary」で、多数のユーザーから要望されていた縦型タブ機能が利用可能になりました。
  ・タブを画面上部からサイドバーに移動でき、多くのタブを開く場合に見やすく管理しやすくなります。
  ・これまで縦型タブはEdgeやFirefoxなど他ブラウザでは採用されていましたが、Chromeでは拡張機能が必要でした。
  ・現在はCanary版限定の機能ですが、将来的に通常版Chromeにも導入される可能性があります。
read: false
ignored: false
pinned: false
memo: ""
