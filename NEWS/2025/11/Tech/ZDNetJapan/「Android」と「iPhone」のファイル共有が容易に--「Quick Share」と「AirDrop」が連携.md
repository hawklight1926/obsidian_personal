...
summary: |-
  ...
  - 現時点では対応機種が「Pixel 10」シリーズに限定されており、他の端末では利用できません。
  - 共有手順は、Android側でファイルを選択し、表示されたiPhoneを選ぶと、iPhone側で受信確認が行われます。
  - ファイル転送時には強力なセキュリティ対策が施されており、外部専門家によるテストも実施されました。
read: false
ignored: false
pinned: false
memo: ""
