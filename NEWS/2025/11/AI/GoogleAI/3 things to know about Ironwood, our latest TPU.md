...
summary: |-
  ...
  ・大規模なAI推論とモデルサービングに特化し、前世代比4倍以上の性能・エネルギー効率を実現しています。  
  ・最大9,216チップを超高速接続する「スーパーポッド」構成により、計算時間とエネルギー消費を大幅に削減します。  
  ・GoogleはAIを用いたチップ設計手法「AlphaChip」を採用し、ハードウェアとAI研究の相互連携で開発を進めています。
read: false
ignored: false
pinned: false
memo: ""
