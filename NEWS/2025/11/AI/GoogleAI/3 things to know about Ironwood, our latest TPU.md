...
summary: |-
  Googleの最新TPU「Ironwood」は、大規模なAI推論とモデルサービングに特化した第7世代のカスタムチップです。
  - 前世代比でチップあたり4倍以上の性能向上と高いエネルギー効率を実現しています。
  - 最大9,216チップを接続するスーパーポッド構成により、大容量メモリへの高速アクセスとデータボトルネックの解消が可能です。
