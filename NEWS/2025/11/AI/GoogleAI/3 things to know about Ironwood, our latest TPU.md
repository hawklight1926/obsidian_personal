...
summary: |-
  Googleの最新第7世代TPU「Ironwood」がクラウドで利用可能となりました。  
  ・大規模で低遅延なAI推論とモデルサービングに特化して設計されています。  
  ・最大9,216チップを接続したスーパーポッドを構成でき、高性能な相互接続ネットワークと大容量共有メモリにより、計算時間とエネルギー消費を大幅に削減します。  
