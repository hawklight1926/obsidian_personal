...
summary: |-
  Googleが第7世代TPU「Ironwood」を発表し、クラウドで利用可能となりました。  
  ・大規模なAI推論とモデルサービング向けに設計され、前世代比4倍以上の性能・エネルギー効率を実現しています。  
  ・最大9,216チップを接続した「スーパーポッド」を構成でき、高速なチップ間接続により大規模モデルの処理を効率化します。  
