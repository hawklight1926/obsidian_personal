...
summary: |-
  Googleの第7世代TPU「Ironwood」がクラウドで利用可能となりました。  
  ・大規模なAI推論とモデルサービングに特化し、前世代比4倍以上の性能向上と省電力化を実現しています。  
  ・最大9,216チップを接続可能なスーパーポッド構成により、データボトルネックを解消し、計算時間とエネルギー消費を大幅に削減します。  
  ・GoogleはAIを用いたチップ設計手法「AlphaChip」を採用し、ハードウェアとAI研究の相互連携によって開発を進めています。
read: false
ignored: false
pinned: false
memo: ""
