...
summary: |-
  ...
  ・Gemini 3 Proを基盤とし、高度な推論能力と豊富な世界知識により、文脈を踏まえた正確なビジュアルを生成します。
  ・複数の言語で、画像内に読み取りやすいテキストを直接レンダリングできることが大きな特長です。
  ・リアルタイム情報の可視化や多言語翻訳にも対応し、Google製品（Geminiアプリ、Google広告など）で利用できます。
read: false
ignored: false
pinned: false
memo: ""
