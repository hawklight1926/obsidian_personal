...
summary: |-
  ...
  ・Gemini 3 Proを基盤とし、高度な推論力と豊富な世界知識により、正確で文脈に富んだビジュアルを生成できます。
  ・複数の言語で、画像内に正確で読みやすいテキストを直接レンダリングできることが特長です。
  ・リアルタイム情報の可視化や多言語コンテンツのローカライズなど、様々な用途で利用が可能であり、GeminiアプリやGoogle AI Studioなどで提供されています。
read: false
ignored: false
pinned: false
memo: ""
