...
summary: |-
  ...
  ・Gemini 3 Proを基盤とし、高度な推論力と豊富な世界知識に基づいて正確で文脈豊かなビジュアルを生成できます。
  ・画像内に複数言語で正確かつ読みやすいテキストを直接描画できることが特長です。
  ・Google検索と連携し、レシピや天気などのリアルタイム情報を元にインフォグラフィックを作成する機能も備えています。
read: false
ignored: false
pinned: false
memo: ""
