...
summary: |-
  ...
  ・Gemini 3 Proを基盤とし、正確で文脈に富んだビジュアルや、複数言語での読みやすい文字入り画像を生成できます。
  ・リアルタイム情報に基づくインフォグラフィックの作成や、プロトタイプの視覚化など、多様な用途に対応しています。
  ・GeminiアプリやGoogle AI Studioなど、各種Google製品で利用を開始することが可能です。
read: false
ignored: false
pinned: false
memo: ""
