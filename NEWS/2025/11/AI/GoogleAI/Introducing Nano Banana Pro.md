...
summary: |-
  ...
  ・Gemini 3 Proを基盤とし、正確で文脈に富んだビジュアルや、複数言語の読みやすいテキストを画像内に生成できます。
  ・リアルタイム情報の取り込みや、インフォグラフィック、図解の作成など、実用的なデザイン支援が可能です。
  ・GeminiアプリやGoogle AI Studioなど、複数のGoogle製品で利用を開始しています。
read: false
ignored: false
pinned: false
memo: ""
