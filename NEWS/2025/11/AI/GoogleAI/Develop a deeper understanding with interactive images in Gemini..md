...
summary: |-
  Geminiアプリに導入された「インタラクティブ画像」機能は、複雑な学術概念を視覚的に探求できる新たな学習支援ツールです。
  - 消化器系や細胞の構造図など、特定の部分をタップすると詳細パネルが表示されます。
  - パネルでは即時の定義や詳しい説明が提供され、能動的な理解を促進します。
  - これにより、受動的な閲覧から双方向の探求へと学習方法が転換され、視覚的で動的な学びが実現します。
read: false
ignored: false
pinned: false
memo: ""
