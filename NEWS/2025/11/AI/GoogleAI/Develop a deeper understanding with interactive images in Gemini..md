...
summary: |-
  Geminiアプリに導入されたインタラクティブ画像機能は、複雑な学習概念を視覚的に探求することを可能にします。
  - 図表の特定部分をタップすると、定義や詳細な説明が表示されるパネルが開きます
  - 消化器系や細胞構造などの学術概念を、能動的に深く理解できるよう設計されています
  - 従来の静的な画像閲覧から、質問を重ねられる動的な学習体験へと進化させます
read: false
ignored: false
pinned: false
memo: ""
