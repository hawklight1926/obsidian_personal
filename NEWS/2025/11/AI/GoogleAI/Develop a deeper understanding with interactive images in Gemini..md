...
summary: |-
  Googleは学習支援ツールGeminiに、複雑な概念を視覚的に探求できる「インタラクティブ画像」機能を追加しました。  
  - 消化器系や細胞の図など、画像の特定部分をタップすると詳細パネルが表示されます。  
  - パネルでは即時の定義や詳細な説明、深掘りコンテンツを提供し、能動的な学習を促進します。  
  - これにより、学習は受動的な閲覧から動的な探求へと変わり、視覚的でアクセスしやすいものとなります。
read: false
ignored: false
pinned: false
memo: ""
