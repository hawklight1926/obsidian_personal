...
summary: |-
  ...
  - 店内ではGoogle PixelとGeminiアプリを使用し、顧客がAIでデジタルアートワークを共同制作できます。
  - 生成されたデザインはGolden Gooseの職人によってスニーカーに手作業で施され、独自性が実現されます。
  - この取り組みは、先端技術と伝統的クラフトマンシップを融合させた新しい顧客体験を目指しています。
read: false
ignored: false
pinned: false
memo: ""
