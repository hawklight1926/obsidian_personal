...
summary: |-
  ...
  - 店頭ではGoogle PixelとGeminiアプリを使用し、AIで作成したデジタルアートを靴にプリントできます。
  - 生成されたデザインはGolden Gooseの職人が手作業でスニーカーに仕上げ、伝統的技法と先端技術を融合させます。
  - この取り組みは、AIがファッション産業の創造性と協働の可能性を広げる事例となっています。
read: false
ignored: false
pinned: false
memo: ""
