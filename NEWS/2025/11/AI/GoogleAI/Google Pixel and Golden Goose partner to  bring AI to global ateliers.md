...
summary: |-
  ...
  - 店頭ではGoogle PixelとGeminiアプリを使用し、自分の名前や好みのスタイルを取り入れたデジタルアートワークを生成できます。
  - 生成されたデザインはGolden Gooseの職人によってスニーカーに手作業で施され、伝統的職人技とデジタル革新が融合します。
  - 両社はテクノロジーが創造性や自己表現の新たな形を促進するとの信念で協業し、ファッション業界の革新を推進しています。
read: false
ignored: false
pinned: false
memo: ""
