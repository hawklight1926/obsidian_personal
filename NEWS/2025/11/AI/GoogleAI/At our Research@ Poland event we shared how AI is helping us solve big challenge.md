...
summary: |-
  Google Researchのポーランドでのイベントでは、現実課題から基礎研究を推進する「マジックサイクル」に基づくAI開発の取り組みが共有されました。
  ・公共衛生や災害対応のためのGoogle Earth AI活用
  ・脳マッピング手法の開発とAIリテラシー教育の推進
  ・科学者の仮想共同研究者としてのAI機能開発
  これらは全て、研究者や政策関係者との協力を基盤として進められています。
read: false
ignored: false
pinned: false
memo: ""
