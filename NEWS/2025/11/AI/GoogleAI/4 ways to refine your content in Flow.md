...
summary: |-
  ...
  - 高機能画像モデル「Nano Banana Pro」を用いて、被写体や照明などを細かく調整できます。
  - 画像への落書きをプロンプトとして認識し、要素を追加・修正することが可能です。
  - 動画クリップ内のオブジェクトを挿入または削除する機能が提供されます。
  - カメラの位置や動きを後から調整する「リシュート」機能で、映像の視点を変更できます。
read: false
ignored: false
pinned: false
memo: ""
