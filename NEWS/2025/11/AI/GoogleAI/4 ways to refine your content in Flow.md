...
summary: |-
  Flowは動画編集アプリにおいて、コンテンツの精密な調整と編集を可能にする新機能を導入しました。
  - 高品質画像モデル「Nano Banana Pro」を使用した画像の生成・編集が可能です。
  - 画像への落書きをプロンプトとして認識し、要素を反映できます。
  - 動画内のオブジェクトの挿入や削除が行え、カメラの動きも調整できます。
read: false
ignored: false
pinned: false
memo: ""
