...
summary: |-
  ...
  - **Gemini**による面倒な作業の代行や、**Google Maps**を活用した混雑回避やインスピレーションの発見が可能です。
  - **Google Shopping**ではAIツールを使った買い物支援や人気ギフトのトレンド「Holiday 100」を確認できます。
  - **Pixel Camera**のプロ設定で休日の写真を美しく残すこともできます。
read: false
ignored: false
pinned: false
memo: ""
