---
url: https://blog.google/products/photos/nano-banana-ai-templates-ask-photos/
...
summary: |-
  GoogleフォトにAI機能が追加され、写真編集や検索の利便性が向上しています。
  ・「Help me edit」でメガネの除去や笑顔の修正など、音声やテキストによる編集が可能に
  ・Nano Bananaを活用したAIテンプレートで、写真のスタイル変更や創作的な加工が容易に
  ・「Ask Photos」が100カ国以上と17言語に対応し、画像内の詳細な検索や対話型編集が可能に
read: false
ignored: false
pinned: false
memo: ""
