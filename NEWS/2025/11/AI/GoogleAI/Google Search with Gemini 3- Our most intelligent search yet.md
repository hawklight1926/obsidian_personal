...
summary: |-
  Googleは検索サービスに最も高性能なAIモデル「Gemini 3」を導入し、検索の推論能力と対話的な体験を大幅に強化しました。
  - 複雑な質問の意図やニュアンスを高度に理解し、信頼性の高い関連情報を発見します。
  - 検索結果にインタラクティブなシミュレーションや計算ツールを動的に生成し、視覚的に理解を深められます。
