...
summary: |-
  ...
  - テキストの正確なレンダリングや照明・構図の制御により、プロ品質の画像を出力できます。
  - 多言語対応やGoogle検索との連携により、多様なコンテキストに合わせた画像生成が可能です。
  - Google AI StudioやVertex AIで提供され、広告制作や教育コンテンツなど様々なアプリケーション開発に活用されます。
read: false
ignored: false
pinned: false
memo: ""
