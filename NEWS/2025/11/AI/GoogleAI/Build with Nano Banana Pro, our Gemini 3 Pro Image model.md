...
summary: |-
  ...
  * テキストの高精度なレンダリングや、照明・構図などの詳細な制御により、プロ品質の画像出力を実現します。
  * Google検索によるグラウンディング機能で事実に基づいたコンテンツ生成が可能であり、多言語ローカライズにも対応しています。
  * Google AI StudioやVertex AIで提供され、広告制作やUIモックアップ作成など、多様なアプリケーション開発に活用できます。
read: false
ignored: false
pinned: false
memo: ""
