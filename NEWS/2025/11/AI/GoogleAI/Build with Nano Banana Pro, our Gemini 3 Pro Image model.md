...
summary: |-
  ...
  * テキストの高精度なレンダリングや、照明・構図などの細かい制御が特徴で、プロ品質の画像出力を実現します。
  * 多言語対応やGoogle検索による情報の基盤付け機能により、多様なコンテキストに沿った正確な画像生成が可能です。
  * このモデルはGoogle AI StudioやVertex AIで有料プレビュー提供が開始され、広告制作や教育コンテンツなど様々なアプリケーション開発に活用できます。
read: false
ignored: false
pinned: false
memo: ""
