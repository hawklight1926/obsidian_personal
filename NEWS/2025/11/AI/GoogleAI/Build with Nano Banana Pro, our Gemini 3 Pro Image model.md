...
summary: |-
  ...
  - テキストの正確なレンダリングや豊富な世界知識に基づく高精細な画像生成が可能です。
  - 照明や構図などの物理的要素を制御でき、プロ品質の出力を実現します。
  - Google検索によるグラウンディング機能で、事実に基づいたアセット制作を支援します。
  - AdobeやFigmaなどのクリエイティブプラットフォームへの統合や、多言語対応も特徴です。
read: false
ignored: false
pinned: false
memo: ""
