...
summary: |-
  GoogleがAIを活用した気象予報モデル「WeatherNext 2」を発表しました。
  ・従来モデルより8倍高速で、1時間単位の高解像度予測が可能です。
  ・単一入力から数百の気象シナリオを1分以内に生成し、物理モデルに基づく予測を実現しています。
  ・予測データはEarth EngineやBigQueryで利用でき、Google CloudのVertex AIでは早期アクセスプログラムを開始しています。
read: false
ignored: false
pinned: false
memo: ""
