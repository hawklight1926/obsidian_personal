...
summary: |-
  Google DeepMindとGoogle Researchは、最も先進的な気象予測AIモデル「WeatherNext 2」を発表しました。
  ・従来モデルより8倍高速で、最大1時間単位の高解像度予測が可能です。
  ・単一出発点から数百通りの気象シナリオを1分以内に生成し、意思決定を支援します。
  ・予測データはEarth EngineやBigQueryで利用可能で、Google検索やMapsなどのサービスにも順次組み込まれています。
read: false
ignored: false
pinned: false
memo: ""
