...
summary: |-
  Googleは最も高性能なAIモデル「Gemini 3」を発表し、推論力とマルチモーダル能力を強化しました。
  ・高度な推論能力を持ち、複雑な問題解決や多様なトピックでの高いベンチマークスコアを達成しています。
  ・Geminiアプリ、AI Studio、Vertex AIなど、Googleの各種製品で利用可能となりました。
  ・「Gemini 3 Deep Think」モードは、Ultra加入者向けに近日提供予定です。
read: false
ignored: false
pinned: false
memo: ""
