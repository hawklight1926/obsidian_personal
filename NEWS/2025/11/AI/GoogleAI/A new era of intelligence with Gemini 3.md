...
summary: |-
  Googleが最高峰のAIモデル「Gemini 3」を発表し、推論能力とマルチモーダル性能が大幅に強化されました。
  - 高度な推論機能「Deep Thinkモード」をUltra加入者向けに提供予定です。
  - 検索、Geminiアプリ、AI Studio、Vertex AIなどGoogle製品群で利用可能です。
  - 主要AIベンチマークで最高スコアを記録し、複雑な問題解決能力が向上しています。
read: false
ignored: false
pinned: false
memo: ""
