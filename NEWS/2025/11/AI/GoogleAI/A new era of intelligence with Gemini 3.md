...
summary: |-
  Googleが最も高度なAIモデル「Gemini 3」を発表し、様々な製品で利用可能になりました。
  - 推論能力とマルチモーダル機能が強化され、複雑な問題解決が可能です。
  - GeminiアプリやAI Studio、Vertex AIなどGoogle製品群で既に利用できます。
  - 近日中に「Deep Thinkモード」が提供され、さらに高度な推論が行えるようになります。
read: false
ignored: false
pinned: false
memo: ""
