...
summary: |-
  Googleが最も高度なAIモデル「Gemini 3」を発表し、推論能力とマルチモーダル性能が大幅に強化されました。
  - 高度な推論機能により、複雑な問題解決やニュアンスの理解が可能です。
  - 検索、Geminiアプリ、AI Studio、Vertex AIなどGoogle製品群で利用できます。
  - Ultra加入者向けに「Deep Thinkモード」も近日提供予定であり、さらなるモデル拡充が計画されています。
read: false
ignored: false
pinned: false
memo: ""
