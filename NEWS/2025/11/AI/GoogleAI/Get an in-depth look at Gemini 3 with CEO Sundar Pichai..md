...
summary: |-
  Googleのサンダー・ピチャイCEOがポッドキャストでAI戦略の現状と未来像を語りました。
  - 2016年の「AIファースト」方針が現在の進展の基盤となっています。
  - 現行のGemini 3やNano Banana Proに加え、量子コンピューティングを今後5〜10年の重要分野と位置づけています。
  - 量子コンピューティングについては「5年後には現在のAIと同様の興奮を生むだろう」と述べています。
read: false
ignored: false
pinned: false
memo: ""
