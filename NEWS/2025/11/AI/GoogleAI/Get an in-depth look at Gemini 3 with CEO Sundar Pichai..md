...
summary: |-
  GoogleのCEOであるサンダー・ピチャイは、AIの進歩と未来について語りました。
  ・2016年に「AIファースト」方針を掲げ、現在の成果につながる投資を行いました。
  ・現在のGemini 3やNano Banana Proだけでなく、量子コンピューティングなど今後10年の長期的な取り組みにも期待を示しています。
  ・ピチャイは、約5年後には量子コンピューティングが現在のAIのような興奮を生むと述べています。
read: false
ignored: false
pinned: false
memo: ""
