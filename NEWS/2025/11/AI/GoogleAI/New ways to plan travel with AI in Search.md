...
summary: |-
  ...
  ・「Canvas」機能では旅行の希望を入力すると、フライトやホテルの情報を統合したカスタム旅程を自動作成できます。
  ・「Flight Deals」は柔軟な旅行希望に応じた最安値航空券をAIが提案し、世界200ヶ国以上で利用可能です。
  ・エージェント機能ではレストランやイベントの空席照会・予約を対話形式で行え、提携サイトへ直接遷移できます。
read: false
ignored: false
pinned: false
memo: ""
