...
summary: |-
  Google検索がAIを活用した旅行計画機能を強化し、旅程作成から予約までを一元支援します。
  ・「Canvas」機能では旅行の希望を入力すると、フライトやホテルのリアルタイム情報を統合した計画を作成できます。
  ・「Flight Deals」は柔軟な旅行者向けに、AIが最安値の行き先を提案する機能で、全世界に展開されています。
  ・レストラン予約などではAIが複数サイトを横断検索し、条件に合った予約可能な選択肢を直接リンク付きで表示します。
read: false
ignored: false
pinned: false
memo: ""
