...
summary: |-
  Google検索がAIを活用した旅行計画機能を強化しました。
  ・「Canvas」では旅行の種類や希望を入力すると、フライトやホテルの情報を統合した計画を作成できます。
  ・「Flight Deals」は柔軟な旅行者向けに、AIが希望に合う最安値の航空券を検索します。
  ・さらに、レストラン予約などでAIが複数サイトを横断して空き状況を確認し、直接予約できる機能も提供しています。
read: false
ignored: false
pinned: false
memo: ""
