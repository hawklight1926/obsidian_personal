...
summary: |-
  ...
  ・「Canvas」では旅行の種類や希望を伝えると、フライトやホテルの情報を統合したカスタム計画を生成できます。  
  ・「Flight Deals」は柔軟な旅行者向けに、AIが最安値の行き先を検索し、世界200以上の国・地域で利用可能です。  
  ・エージェント機能により、レストランやイベントの予約を複数プラットフォームから検索・比較し、直接予約へ導きます。
read: false
ignored: false
pinned: false
memo: ""
