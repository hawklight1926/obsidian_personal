...
summary: |-
  Google検索がAIを活用した新機能で旅行計画を支援します。  
  ・「Canvas」では旅行の種類や希望を伝えると、フライトやホテルの情報を統合した計画を作成できます。  
  ・「Flight Deals」は柔軟な旅行者向けに、AIが最安値の行き先を提案する機能です。  
  ・エージェント機能では、レストランやイベントの予約を複数サイトから検索し、直接予約できるようになります。
read: false
ignored: false
pinned: false
memo: ""
