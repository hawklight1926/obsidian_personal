---
url: "https://blog.google/outreach-initiatives/education/ai-learning-commitments/"
...
summary: |-
  GoogleはAIによる教育の変革を推進するため、新たなフォーラム開催と資金提供を発表しました。
  ・3年間で3000万ドルを学習プロジェクトに拠出し、エストニアの「AI Leap」など教育機関との連携を強化します。
  ・YouTubeやGeminiに学習支援AI機能を追加し、教材の理解促進を図ります。
  ・ランダム化比較試験によりAIの教育効果を検証し、学習成果向上の実証を進めています。
read: false
ignored: false
pinned: false
memo: ""
