...
summary: |-
  Googleが、クラウド上のGeminiモデルの能力を活用しながらユーザーデータを保護する新たなAI処理基盤「Private AI Compute」を発表しました。
  - クラウドの高性能AIとオンデバイス処理と同等のプライバシー保証を両立させます。
  - ユーザーデータは隔離された安全な領域で処理され、Googleを含む他者からも保護されます。
