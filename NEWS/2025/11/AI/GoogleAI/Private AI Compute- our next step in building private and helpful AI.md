...
summary: |-
  Googleがクラウド上のGeminiモデルの能力を活用しつつ、ユーザーデータのプライバシーを保護する新たなAI処理基盤「Private AI Compute」を発表しました。
  ・クラウドAIの処理能力と、オンデバイス処理と同等の高いプライバシー保証を両立させています。
  ・ユーザーの個人データは隔離・保護され、Googleを含む第三者からもアクセスできない仕組みです。
  ・具体的には、Pixel端末の「Magic Cue」や「Recorder」アプリなどで、より高度でプライベートなAI体験の実現に活用されています。
read: false
ignored: false
pinned: false
memo: ""
