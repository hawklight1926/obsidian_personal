...
summary: |-
  GoogleはGeminiアプリ内で、AI生成画像を検証する機能を導入し、コンテンツの透明性を高めています。
  
  - ユーザーは画像をアップロードし、Google AIで生成または編集されたか質問できます。
  - 検証には透かし技術「SynthID」が利用され、これまでに200億以上のコンテンツに適用されています。
  - 今後は検証対象を動画や音声に拡大し、業界標準のC2PAメタデータにも対応する予定です。
read: false
ignored: false
pinned: false
memo: ""
