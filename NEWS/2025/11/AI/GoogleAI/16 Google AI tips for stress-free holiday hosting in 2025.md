...
summary: |-
  ...
  ・Geminiアプリではパーティー計画のためのカスタムAI「Gem」を作成でき、メニューや招待状の作成を支援します。  
  ・Pixelのスクリーンショット機能ではレシピやアイデアを整理・検索でき、調理や準備を効率化できます。  
  ・さらに、Gemini LiveやNano Banana Proを用いて、装飾の相談やパーティー用画像の生成も可能です。
read: false
ignored: false
pinned: false
memo: ""
