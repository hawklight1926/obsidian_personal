...
summary: |-
  ...
  - Geminiを活用したパーティー計画の作成や、Gemini Liveを用いた装飾アイデアの対話型相談が可能です。
  - Pixel Screenshotsでレシピやアイデアを整理したり、Nano Banana Proでパーティー用の画像を生成できます。
  - さらにSearchのAIモードで会話形式の買い物や、Gemini for Homeによる調理サポートも利用できます。
read: false
ignored: false
pinned: false
memo: ""
