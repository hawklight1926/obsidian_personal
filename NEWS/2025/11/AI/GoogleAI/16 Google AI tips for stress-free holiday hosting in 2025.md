...
summary: |-
  ...
  ・Geminiアプリでパーティー計画を支援するカスタムAI「Gem」の作成や、会話型検索による装飾品の購入が可能です。  
  ・Pixelのスクリーンショット機能でレシピや情報を整理したり、Nano Banana Proでパーティー用の画像を生成できます。  
  ・さらに、Gemini for Homeを活用した調理のサポートなど、準備から本番までストレス軽減に役立つ機能が揃っています。
read: false
ignored: false
pinned: false
memo: ""
