...
summary: |-
  Googleは2025年の休日シーズンのホスト業務を支援するAIツールを複数提供します。
  ・Geminiではパーティー計画の作成や会話によるアイデア出しが可能です
  ・Nano Banana Proで招待状の画像生成、Mixboardで装飾案の可視化が行えます
  ・Pixel Screenshotsで保存情報の検索、Searchでの買い物支援なども活用できます
read: false
ignored: false
pinned: false
memo: ""
