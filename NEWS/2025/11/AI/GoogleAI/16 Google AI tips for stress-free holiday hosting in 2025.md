...
summary: |-
  Googleは2025年のホリデーシーズンに向け、AIツールを活用したストレスフリーなホスト術を提案しています。  
  ・Geminiアプリでパーティー計画を支援する「Gem」の作成や、会話型AI「Gemini Live」による装飾の相談が可能です。  
  ・画像生成モデル「Nano Banana Pro」で招待状の作成、Pixelのスクリーンショット機能で情報整理が行えます。  
