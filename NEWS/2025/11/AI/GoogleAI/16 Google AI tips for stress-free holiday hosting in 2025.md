...
summary: |-
  ...
  ・Geminiではカスタムのパーティープランナー「Gem」を作成し、メニューや招待状の作成を支援します。  
  ・Pixelのスクリーンショット機能でレシピやアイデアを整理し、検索で効率的に情報を管理できます。  
  ・Nano Banana ProやMixboardを用いて、招待状や装飾のビジュアルを簡単に生成・考案することも可能です。
read: false
ignored: false
pinned: false
memo: ""
