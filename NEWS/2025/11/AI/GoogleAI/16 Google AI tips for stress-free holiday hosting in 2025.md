...
summary: |-
  Googleは2025年の休日ホスティングを支援するAIツールを提供しています。
  ・GeminiではカスタムAI「Gem」でパーティー計画の作成や装飾アイデアの対話型相談が可能です。
  ・Nano Banana Proで招待状用の画像生成、Pixelスクリーンショットで計画情報の整理ができます。
  ・検索のAIモードでは会話型ショッピング、Gemini in Chromeではレシピ情報の統合も支援します。
read: false
ignored: false
pinned: false
memo: ""
