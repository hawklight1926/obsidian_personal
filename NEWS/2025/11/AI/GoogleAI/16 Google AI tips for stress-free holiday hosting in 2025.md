...
summary: |-
  ...
  ・Geminiではパーティー計画の作成や会話型の装飾アイデア相談が可能です。
  ・Nano Banana Proで招待状用の画像生成、Mixboardでテーブル装飾のビジュアル化を実現します。
  ・Pixel Screenshotsでスクリーンショット管理、Searchでは対話型ショッピングや在庫確認をサポートします。
read: false
ignored: false
pinned: false
memo: ""
