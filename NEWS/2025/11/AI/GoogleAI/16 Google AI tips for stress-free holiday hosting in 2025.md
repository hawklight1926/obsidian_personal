...
summary: |-
  Googleは2025年の休日ホスティングを支援するため、GeminiやPixelなどのAIツールを複数提供しています。  
  ・Geminiアプリではパーティー計画の作成や装飾のアイデア出しを対話的にサポートします。  
  ・Pixelのスクリーンショット機能ではレシピやDIY情報を整理・検索でき、調理工程を効率化できます。  
  ・AIを活用した画像生成ツールでは、パーティー招待状の作成など視覚的な準備も可能です。
read: false
ignored: false
pinned: false
memo: ""
