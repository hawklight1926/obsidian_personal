...
summary: |-
  Googleは2025年の休日ホスティングを支援するAIツールを多数提供しています。  
  ・Geminiアプリでパーティー計画を支援するカスタム「Gem」の作成や、音声対話機能「Gemini Live」による装飾のアイデア出しが可能です。  
  ・画像生成モデル「Nano Banana Pro」で招待状用の画像を作成したり、Pixelのスクリーンショット機能でレシピなどの情報を整理できます。  
  ・さらに、Chrome上のGeminiで情報を統合したり、検索機能で会話形式で装飾品を購入するなど、準備から調理までをサポートします。
read: false
ignored: false
pinned: false
memo: ""
