...
summary: |-
  ...
  ・Geminiアプリでパーティー計画を支援するカスタムAI「Gem」の作成や、視覚的会話が可能な「Gemini Live」を活用できます。  
  ・画像生成モデル「Nano Banana Pro」で招待状の作成、AI実験「Mixboard」で装飾アイデアの可視化が可能です。  
  ・Pixelのスクリーンショット検索機能やChromeのGeminiにより、情報の整理や調理工程の効率化も支援されます。
read: false
ignored: false
pinned: false
memo: ""
