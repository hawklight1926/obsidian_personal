...
summary: |-
  ...
  ・Google Cloudと連携し、AIを活用したプラットフォームで建設工程の最適化と加速を図っています。
  ・同社は既に原子力向けAI基盤「Hive」や生成AI「Bertha」を保有し、規制環境下でのAI活用基盤を整えています。
  ・AIは建設コスト削減に加え、運転・保守の効率化にも応用され、業界変革の触媒と位置付けられています。
read: false
ignored: false
pinned: false
memo: ""
